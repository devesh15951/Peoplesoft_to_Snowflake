...
def csv_staging(table_parameter):
    ...
    upd_filename="""//apps//python//data//snowflake_merge//S_CS_NoHousekeeping//""" + tablename + """_Update.csv"""
    del_filename="""//apps//python//data//snowflake_merge//S_CS_NoHousekeeping//""" + tablename + """_Delete.csv"""
...
#         print(tablename[i],"\n")
        ...
        a.table_name ='""" +tablename[i]+ """' and b.uniqueness='UNIQUE' order by a.table_name, a.index_name, a.column_position"""
